 ...
 */
const Footer: VFC<Props> = ({ className }) => {
	return (
		<footer
			className={className}
			tw="absolute bottom-0   w-full text-white flex "
			role="contentinfo"
		>
			<div tw="w-full flex-center flex-col bg-primary self-end h-36  md:(h-56 text-2xl)">
				<ul
					tw="flex items-center  space-x-6 md:(space-x-8)"
